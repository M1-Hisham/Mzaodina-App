...
class _ApiService implements ApiService {
  ...
  @override
  Future<void> appleLogin(Map<String, dynamic> body) async {
  ...
  @override
  Future<ShowAuctionModel> getShowAuction(String slug) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ShowAuctionModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/auctions/${slug}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ShowAuctionModel _value;
    try {
      _value = ShowAuctionModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
